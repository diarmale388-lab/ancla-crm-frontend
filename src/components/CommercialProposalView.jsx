...
export const CommercialProposalView = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased pb-20 selection:bg-gold-500 selection:text-white">
      ...
      <header className="bg-gradient-to-br from-slate-950 via-[#07171d] to-[#042921] text-white px-4 sm:px-6 pt-10 sm:pt-14 pb-14 sm:pb-16 rounded-b-[28px] sm:rounded-b-[40px] shadow-2xl relative overflow-hidden">
        <div className="absolute -top-24 -right-24 w-80 sm:w-96 h-80 sm:h-96 bg-gold-500/15 rounded-full blur-3xl pointer-events-none"></div>
        
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center relative z-10">
          
          <div className="inline-flex items-center space-x-2 bg-gold-500/15 border border-gold-500/30 text-gold-400 px-3.5 sm:px-4 py-1.5 rounded-full text-[10px] sm:text-xs font-black tracking-wider sm:tracking-widest uppercase mb-4 sm:mb-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3.5 w-full max-w-3xl text-left">
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-md p-3 sm:p-3.5 rounded-xl sm:rounded-2xl">
              ...
              <span className="text-xs sm:text-sm font-black text-gold-400 mt-0.5 block">8.000.000 COP</span>
            </div>
            <div className="bg-white/5 border border-white/10 backdrop-blur-md p-3 sm:p-3.5 rounded-xl sm:rounded-2xl">
      ...
      <main className="max-w-4xl mx-auto px-3.5 sm:px-6">
        ...
        {totalCommentsCount > 0 && (
          <div className="my-4 p-3 sm:p-3.5 bg-gold-50 border border-gold-200 rounded-2xl flex flex-col sm:flex-row gap-2.5 sm:gap-2 items-start sm:items-center justify-between shadow-xs">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-navy-900 hover:bg-navy-800 text-white text-xs font-bold py-2 sm:py-1.5 px-4 rounded-xl shadow-xs transition-all flex items-center justify-center space-x-1.5 cursor-pointer"
            >
        ...
        {activeTab === 'resumen' && (
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 p-5 sm:p-8 shadow-sm space-y-5 sm:space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
              ...
              <div className="bg-gold-50 border border-gold-200 p-4 sm:p-5 rounded-2xl">
                <h4 className="text-gold-800 font-extrabold text-xs sm:text-sm mb-1.5 flex items-center space-x-2">
            ...
            <div className="bg-slate-50 border border-slate-200 p-4 sm:p-5 rounded-2xl">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-2 items-center justify-center text-xs font-bold text-slate-700 text-center">
                ...
                <span className="w-full sm:w-auto bg-gold-50 text-gold-800 px-3 py-2 rounded-xl border border-gold-300 shadow-xs">🤖 CRM & Sofi AI 24/7</span>
                <span className="text-slate-400 hidden sm:inline">➔</span>
                <span className="text-slate-400 sm:hidden">↓</span>
                  ...
                  <div key={item.key} className={`border rounded-2xl p-4 sm:p-4.5 transition-all bg-white relative flex flex-col justify-between ${item.isNext ? 'border-blue-200 bg-blue-50/20' : 'border-slate-200 hover:border-slate-300'}`}>
                    <div>
                      <div className="flex flex-wrap justify-between items-center gap-1.5 mb-2">
                        <span className={`inline-block text-[9.5px] sm:text-[10px] font-black uppercase px-2 sm:px-2.5 py-0.5 rounded-full border ${item.isNext ? 'bg-blue-100 border-blue-200 text-blue-800' : 'bg-gold-50 border-gold-200 text-gold-700'}`}>
                          {item.status}
                        </span>
                    ...
                    <div>
                      ...
                      <div className={`mt-2.5 pt-2 border-t text-[10.5px] sm:text-[11px] font-bold flex items-center space-x-1.5 ${item.isNext ? 'border-blue-100 text-blue-700' : 'border-slate-100 text-gold-700'}`}>
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[540px]">
                ...
                <tbody className="divide-y divide-slate-100">
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="p-3 sm:p-4"><span className="bg-gold-50 text-gold-700 px-2 py-0.5 rounded-full font-bold text-[9.5px] border border-gold-200">Activo</span></td>
                    <td className="p-3 sm:p-4 font-mono font-bold text-gold-700 bg-gold-50/50">~$40.000 COP/mes</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="p-3 sm:p-4"><span className="bg-gold-50 text-gold-700 px-2 py-0.5 rounded-full font-bold text-[9.5px] border border-gold-200">Activo</span></td>
                    <td className="p-3 sm:p-4 font-mono font-bold text-gold-700 bg-gold-50/50">~$100.000 COP/mes</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="p-3 sm:p-4"><span className="bg-gold-50 text-gold-700 px-2 py-0.5 rounded-full font-bold text-[9.5px] border border-gold-200">Configurado</span></td>
                    <td className="p-3 sm:p-4 font-mono font-bold text-gold-700">Incluido en Google</td>
                  </tr>
                </tbody>
              </table>
            </div>

            <div className="p-4 bg-gold-50 rounded-2xl border border-gold-200 text-xs text-navy-900 leading-relaxed">
        ...
        {activeTab === 'propuesta' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            {/* CAJA DE INVERSIÓN */}
            <div className="bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 text-white rounded-2xl sm:rounded-3xl p-5 sm:p-10 shadow-2xl border border-gold-500/30 relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 pb-5 sm:pb-6 border-b border-white/10 mb-5 sm:mb-6">
                <div>
                  <span className="text-[10px] sm:text-xs font-black text-gold-400 uppercase tracking-widest block">Propuesta Comercial de Valor</span>
                ...
                <div className="sm:text-right">
                  <div className="text-2xl sm:text-4xl font-black text-gold-400 tracking-tight">8.000.000 COP</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4 mb-5 sm:mb-6">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl flex flex-col justify-between">
                  <div>
                    <div className="flex flex-wrap justify-between items-start gap-1.5 mb-1.5">
                      ...
                      <span className="text-[10px] font-black text-gold-300 bg-gold-500/20 border border-gold-500/30 px-2 py-0.5 rounded-full">
                        $4.500.000 COP
                      </span>
                    </div>
                    <span className="inline-block text-[9px] sm:text-[9.5px] font-bold text-gold-400 mb-1.5 uppercase">✅ Activo Entregado y Operativo</span>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl flex flex-col justify-between">
                  <div>
                    ...
                    <span className="inline-block text-[9px] sm:text-[9.5px] font-bold text-gold-400 mb-1.5 uppercase">✅ Incluye hasta el 30 de Agosto</span>
                    <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <div className="bg-white/10 border border-white/15 p-4 sm:p-5 rounded-2xl text-xs text-slate-200 space-y-2.5 sm:space-y-3">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1 sm:gap-2 pb-2.5 border-b border-white/10 text-xs font-bold text-slate-300">
                  ...
                  <span className="text-gold-400 font-extrabold text-sm">= $8.000.000 COP</span>
                </div>
                ...
                <div className="space-y-1">
                  <div className="font-extrabold text-white text-xs mb-1 flex items-center space-x-2">
                    ...
                    <span className="text-[9.5px] font-black text-gold-400 bg-gold-500/20 px-2 py-0.5 rounded-full">A Mutuo Acuerdo</span>
                  </div>
              ...
              <div className="text-center pt-6 sm:pt-8">
                <button 
                  ...
                  className="w-full sm:w-auto bg-gold-500 hover:bg-gold-600 text-navy-950 font-black text-sm sm:text-base py-3.5 sm:py-4 px-6 sm:px-10 rounded-full shadow-xl shadow-gold-500/30 transition-all transform hover:-translate-y-0.5 cursor-pointer flex items-center justify-center space-x-2 mx-auto"
                >
            ...
            <form onSubmit={handleSaveComment} className="space-y-3 sm:space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2 sm:py-2.5 text-xs text-slate-800 placeholder-slate-400 focus:bg-white focus:border-gold-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 sm:p-3.5 text-xs text-slate-800 placeholder-slate-400 focus:bg-white focus:border-gold-500 focus:outline-none resize-none"
                ></textarea>
              </div>

              {commentSuccess && (
                <div className="p-2.5 bg-gold-50 border border-gold-200 text-gold-800 text-xs font-bold rounded-xl flex items-center space-x-2">
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 pt-1">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-navy-900 hover:bg-navy-800 text-white font-bold text-xs px-5 py-2.5 rounded-xl shadow-md shadow-navy-900/20 transition-all flex items-center justify-center space-x-1.5 cursor-pointer disabled:opacity-50"
                >
      ...
      {showThankYouModal && (
        <div className="fixed inset-0 bg-black/75 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 z-50 animate-fadeIn">
          <div className="bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 text-white rounded-2xl sm:rounded-3xl max-w-lg w-full p-6 sm:p-9 shadow-2xl border border-gold-500/40 relative text-center max-h-[92vh] overflow-y-auto">
            ...
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gold-500/20 text-gold-400 border border-gold-500/30 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-lg shadow-gold-500/10 shrink-0">
            ...
            <div className="bg-white/5 border border-white/10 p-3.5 sm:p-4 rounded-2xl text-left mb-5 sm:mb-6 space-y-1.5">
              <span className="text-[10px] font-bold text-gold-400 uppercase tracking-wider block">Próximos Pasos Inmediatos:</span>
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full sm:w-auto bg-gold-500 hover:bg-gold-400 text-slate-950 font-black text-xs py-3.5 px-6 rounded-xl shadow-lg shadow-gold-500/20 transition-all flex items-center justify-center space-x-2"
              >

  ...
  return (
    <div className="flex-1 flex h-full overflow-hidden bg-slate-50 dark:bg-navy-950 relative w-full">
      ...
      >
        ...
        <div className="px-2 py-1 md:px-3.5 md:py-2 bg-gradient-to-r from-gold-500/10 via-navy-900/5 to-purple-500/10 dark:from-navy-950/40 dark:via-navy-900/25 dark:to-purple-950/30 border-t border-slate-200 dark:border-white/5 flex items-center gap-1.5 md:gap-2 overflow-x-auto no-scrollbar scroll-smooth shadow-inner">
          <div className="flex items-center space-x-1 text-[9px] md:text-[10px] font-black uppercase text-gold-600 dark:text-gold-400 shrink-0 pr-0.5 select-none">
            <Sparkles className="w-3 h-3 md:w-3.5 md:h-3.5 text-gold-500 animate-pulse" />
            <span className="sm:hidden">Sofi</span>
          ...
          {[
            ...
            <button
              ...
              className="px-2 py-0.5 md:px-2.5 md:py-1 rounded-lg md:rounded-xl bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-white/10 hover:border-gold-500/50 hover:bg-gold-50 dark:hover:bg-gold-500/10 text-[#0f172a] dark:text-[#f8fafc] text-[10px] md:text-[11px] font-bold shrink-0 transition-all active:scale-95 shadow-xs cursor-pointer flex items-center space-x-1"
        ...
        <div className="px-2 pt-2 pb-3 sm:p-4 sm:pb-2 border-t border-slate-200 dark:border-white/5 bg-white dark:bg-dark-900 relative">
          ...
          <div className="flex items-center gap-0.5 mb-1.5 md:mb-2.5 bg-slate-100 dark:bg-slate-900/60 p-0.5 md:p-1 rounded-lg md:rounded-xl w-max border border-slate-200 dark:border-white/5">
            <button
              type="button"
              onClick={() => setIsInternalNote(false)}
              className={`px-2 py-1 md:px-3 md:py-1.5 rounded-md md:rounded-lg text-[9px] md:text-[10px] font-bold flex items-center space-x-1 transition-all cursor-pointer ${
                !isInternalNote
            ...
            >
              <Send className="w-3 h-3 md:w-3.5 md:h-3.5 text-gold-500" />
            ...
            >
              ...
              <span className="md:hidden">Nota</span>
              <span className="hidden md:inline">Nota Interna (Privada)</span>
            </button>
          </div>

          {/* Card premium interactivo de Nota Interna */}
          {isInternalNote && (
            <div className="mb-2 md:mb-3.5 p-2.5 md:p-4 bg-gradient-to-tr from-amber-500/10 to-amber-600/5 border border-amber-300 dark:border-amber-500/20 rounded-xl md:rounded-2xl animate-fade-in space-y-2 md:space-y-3 shadow-sm shadow-amber-500/5">
          ...
          <form onSubmit={handleSend} className="flex items-center md:items-end gap-1.5 md:gap-2">
            
            {/* Botón de Plantillas Inteligentes (Todas las Vistas: Móvil y Desktop) */}
            <button
              type="button"
              onClick={() => setShowTemplates(!showTemplates)}
              className={`p-2 md:p-2.5 rounded-xl border transition-all shrink-0 cursor-pointer flex items-center justify-center self-center md:self-auto ${
                showTemplates 
            ...
            <button
              ...
              className="p-2 md:p-2.5 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/10 cursor-pointer active:scale-95 shrink-0 self-center md:self-auto"
            ...
            <div className="flex-1 min-w-0 relative">
              <textarea
                ...
                className={`w-full min-h-[40px] md:min-h-[44px] max-h-[180px] border rounded-xl px-3 py-2 md:px-3.5 md:py-2.5 text-base md:text-sm leading-relaxed focus:outline-none transition-all resize-none overflow-y-auto ${
                  isInternalNote 
            ...
            <button
              type="submit"
              className={`p-2 md:p-3 rounded-xl text-white shadow-md transition-all shrink-0 active:scale-95 cursor-pointer min-w-[40px] min-h-[40px] md:min-w-[44px] md:min-h-[44px] flex items-center justify-center self-center md:self-auto ${
                isInternalNote 
